...
|---|---|---|---|---|---|
| #178 | open | local_done | 0.5.9-beta.2 | `desktop-issue-178-hermes-localappdata` | `%LOCALAPPDATA%` / Hermes Windows Native handling is implemented locally; keep GitHub open until release. |
| #170 | open | local_done | 0.5.9-beta.2 | `skill-package-boundary` | GitHub package install now preserves non-`SKILL.md` files locally; keep GitHub open until release. |
| #169 | open | local_done | 0.5.9-beta.2 | `web-prompt-clipboard-copy` | Web Markdown prompt copy fallback is implemented locally; keep GitHub open until release. |
| #168 | open | local_done | 0.5.9-beta.2 | `my-skill-source-update` | False local-modified detection fix is implemented locally; keep GitHub open until release. |
