...
- Add a graph relation table for non-tree relations (`related_to`,
  `variant_of`, `depends_on`, `next_step`) as the storage boundary for future
  lightweight inline controls.
