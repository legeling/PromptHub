...
- Store card inventory chips should read like product copy, for example `Includes 1 Skill` or `包含 1 个 Skill`, instead of raw internal notation such as `Skills · 1`.
