...
export const ui = {
  zh: {
    ...
    seo: {
      ...
      description: 'PromptHub 是一款开源、本地优先的 AI Prompt 与 Skill 管理工具。内建技能商店，支持一键安装 SKILL.md 到 Claude Code、Cursor、Windsurf 等 12+ 平台。版本控制、多模型测试、WebDAV 同步，隐私优先。',
      keywords: 'PromptHub, Prompt管理, Skill管理, SKILL.md, AI技能, 开源, 本地优先, Claude Code, Cursor, Windsurf, 版本控制, 大模型工具',
    ...
    features: {
      ...
      titleEnd: '而生',
      subtitle: '管理 Prompt 与 SKILL.md 技能，一键安装到 Claude Code、Cursor、Windsurf 等 12+ 平台。',
      items: [
        {
          title: "极致私有：离线是最好的加密",
  ...
  en: {
    ...
    seo: {
      ...
      description: 'PromptHub is an open-source, local-first AI Prompt & Skill management tool. Built-in skill store with one-click install to Claude Code, Cursor, Windsurf, Codex and 12+ platforms. Version control, multi-model testing, WebDAV sync. Privacy first.',
      keywords: 'PromptHub, Prompt Management, Skill Management, SKILL.md, AI Skills, Open Source, Local-first, Claude Code, Cursor, Windsurf, Version Control, LLM Testing',
    },
    features: {
      titleStart: 'Designed for',
      titleHighlight: 'AI Engineers',
      titleEnd: '',
      subtitle: 'Manage prompts & SKILL.md skills, one-click install to Claude Code, Cursor, Windsurf and 12+ platforms.',
      items: [
        {
