  ...
  return mergeMocks(
    {
      ...
      cli: {
        getStatus: vi.fn().mockResolvedValue({
          ...
          releaseTag: "v0.5.7-beta.2",
          installCommand:
            "pnpm add -g https://github.com/legeling/PromptHub/releases/download/v0.5.7-beta.2/prompthub-cli-0.5.7-beta.2.tgz",
          installSource:
            "https://github.com/legeling/PromptHub/releases/download/v0.5.7-beta.2/prompthub-cli-0.5.7-beta.2.tgz",
        }),
