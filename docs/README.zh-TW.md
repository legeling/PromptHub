...
最新穩定版 **v0.5.8**；目前預覽版 **v0.5.9-beta.1** 已開放測試。穩定版直鏈繼續指向 v0.5.8，預覽版請從 GitHub Prerelease 下載：
...
| 預覽版  | [![Preview v0.5.9-beta.1](https://img.shields.io/badge/Preview-0.5.9--beta.1-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.9-beta.1) | [GitHub Prerelease v0.5.9-beta.1](https://github.com/legeling/PromptHub/releases/tag/v0.5.9-beta.1) |
...
- MCP 管理進入桌面預覽：本機庫、模板商店、Agent 分發、健康檢查與 CLI 命令打通
- Prompt 關係樹、語義關係面板和拖拽分組進入現有 Prompt 工作流
- Git / SSH Skill 匯入、大倉庫結果瀏覽、圖片資源預覽和標題複製體驗繼續打磨
