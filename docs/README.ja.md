...
| プレビュー       | [![Preview v0.5.7-beta.1](https://img.shields.io/badge/Preview-v0.5.7--beta.1-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.7-beta.1) | 現在のプレビュー版は `v0.5.7-beta.1` です。必要なら「設定 → このアプリについて」でプレビューチャンネルを有効化して自動チェックと更新も使えます。 |
...
### v0.5.7-beta.1 ← 現在のプレビュー版

- built-in への完全なパス上書きを含む unified agent configuration model
- プロジェクト内ローカル agent ディレクトリへの Skill 直接配布
- Prompt 詳細インライン編集 UX の改善
